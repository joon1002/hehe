...
int main() {
    ...
    std::cout << "Processed Latitude: " << static_cast<double>(received_coords[0]) / 100 << std::endl;
    std::cout << "Processed Longitude: " << static_cast<double>(received_coords[1]) / 100 << std::endl;
